...
const Sidebar = () => {
    return (
        ...
        <div class="flex flex-wrap bg-gray-100 w-full h-screen">
            <div class="w-3/12 bg-indigo-400 rounded-r p-3 shadow-lg">
            <div class="flex items-center space-x-4 p-2 mb-5">
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li>
                        <a href="Products.js" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                            <span class="text-gray-600">
                                <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
